...
<div class="white_container">
	<table class="table table-striped" id="table">
		...
		<tbody>
			...
			<tr class="item">
				<td><?php echo e($ta->name); ?></td>
				<td><?php echo e($ta->updated_at->format('M d, Y - h:i:s A')); ?></td>
				<td>
					<button type="button" title="View or Edit" class="btnViewCityMun btn btn-warning btn-sm" onclick="redirect('/admin-panel/tourism/tourist-attractions/<?php echo e($ta->id); ?>')"><i class="fa fa-eye" aria-hidden="true"></i></button>
					<button type="button" title="Delete" class="btndelete btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal" data-url="/admin-panel/tourism/tourist-attractions/<?php echo e($ta->id); ?>/delete"><i class="fa fa-trash" aria-hidden="true"></i></button>
				</td>
			</tr>
