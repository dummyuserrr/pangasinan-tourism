...
<div class="white_container">
	<form method="post" action="/admin-panel/the-province/delicacies/<?php echo e($delicacy->id); ?>/update" enctype="multipart/form-data">
		...
		<div class="row">
			<div class="col-lg-8">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="name" name="name" value="<?php echo e($delicacy->name); ?>">
				</div>
				<div class="form-group">
					<label for="content">Description:</label>
					<textarea type="text" class="form-control" rows="5" name="description"><?php echo e($delicacy->description); ?></textarea>
				</div>
			...
			<div class="col-lg-4">
				<div class="form-group">
					...
					<div class="thumbnails">
						...
						<div class="box cmsImageBox" title="Click to view or delete image" style="background-image: url('/<?php echo e($image->path); ?>');" data-toggle="modal" data-target="#imageModal" data-url="/admin-panel/the-province/delicacies/<?php echo e($image->id); ?>/delete-image">
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<?php if($delicacy->images->count() > 1): ?>
