...
<div class="white_container">
	<form method="post" action="/admin-panel/tourism/delicacies/<?php echo e($delicacy->id); ?>/update" enctype="multipart/form-data">
			...
			<div class="col-lg-4">
				<div class="form-group">
					...
					<div class="thumbnails">
						...
						<div class="box cmsImageBox" title="Click to view or delete image" style="background-image: url('/<?php echo e($image->path); ?>');" data-toggle="modal" data-target="#imageModal" data-url="/admin-panel/tourism/delicacies/<?php echo e($image->id); ?>/delete-image">
