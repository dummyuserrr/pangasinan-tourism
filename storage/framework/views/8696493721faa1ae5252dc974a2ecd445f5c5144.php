			...
			<div class="col-lg-8">
				...
				<div class="form-group">
					...
					<select type="text" class="form-control" id="category" name="category">
						...
						<option <?php echo e(($mv->category == 'cafe') ? 'selected' : ''); ?> value="cafe">Cafe</option>
						<option <?php echo e(($mv->category == 'beaches') ? 'selected' : ''); ?> value="beaches">Beaches</option>
						<option <?php echo e(($mv->category == 'delicacies') ? 'selected' : ''); ?> value="delicacies">Delicacies</option>
						<option <?php echo e(($mv->category == 'restaurant') ? 'selected' : ''); ?> value="restaurant">Restaurant</option>
					</select>
				</div>
				<div class="form-group">
