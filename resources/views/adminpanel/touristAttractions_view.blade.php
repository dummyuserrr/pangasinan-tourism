...
<div class="white_container">
	<form method="post" action="/admin-panel/tourism/tourist-attractions/{{ $ta->id }}/update" enctype="multipart/form-data">
		{{ csrf_field() }}
		{{ method_field('patch') }}
		<div class="row">
			<div class="col-lg-8">
				...
				<div class="form-group">
					...
					<textarea type="text" class="form-control" rows="5" name="description">{{ $ta->description }}</textarea>
				</div>
				<div class="form-group longlatform">
					<label for="latitude">Latitude: <span class="req">*</span></label>
					<input type="text" class="form-control" id="latitude" value="{{ $ta->lat }}" name="lat">
				</div>
				<div class="form-group longlatform">
					<label for="longitude">Longitude: <span class="req">*</span></label>
					<input type="text" class="form-control" id="longitude" value="{{ $ta->long }}" name="long">
				</div>
			...
			<div class="col-lg-4">
				<div class="form-group">
					...
					<div class="thumbnails">
						...
						<div class="box cmsImageBox" title="Click to view or delete image" style="background-image: url('/{{ $image->path }}');" data-toggle="modal" data-target="#imageModal" data-url="/admin-panel/tourism/tourist-attractions/{{ $image->id }}/delete-image">
							<img src="/{{ $image->path }}">
						</div>
						@endforeach
					</div>
